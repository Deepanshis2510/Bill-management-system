...
<body>
    ...
    <div class="back-button-container">
        ...
        <form id="billForm" action="./api/submit_bill.php" method="POST" enctype="multipart/form-data">
...
<input type="text" id="manualPanNo" name="manual_pan_no" placeholder="Enter PAN Number" style="display:none;" maxlength="10" oninput="validatePanNumber(this)">
            ...
            <input type="text" id="authorizedPerson" name="authorized_person" value="<?php echo htmlspecialchars($username); ?>" readonly required>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                url: './api/fetch_department_names.php',
                type: 'GET',
                success: function (response) {
            ...
            $('#partyName').change(function () {
                ...
                if (partyId) {
                    $.ajax({
                        url: './api/fetch_party_details.php',
                        type: 'GET',
                        data: { id: partyId },
                        success: function (response) {
