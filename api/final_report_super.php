...
// Fetch bills with status "Forward to Final Approval" using PDO with a JOIN to get the party name from master_data
$sql = "SELECT bills.*, master_data.party_name 
        FROM bills 
        LEFT JOIN master_data ON bills.party_id = master_data.id 
        WHERE bills.status = 'Forward to Final Approved'";
...
<body>
    <h1>Pending Bills for Approval</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <form method="post" action="super_process_bill.php" style="display:inline;">
                                <input type="hidden" name="bill_id" value="<?php echo $row['id']; ?>">
                                <button type="submit" name="action" value="final_approve" class="approve-button">Final Approve</button>
    ...
    <script>
        ...
        var alertMessage = "<?php echo addslashes($alertMessage); ?>";
        if (alertMessage) {
        ...
        function viewBillDetails(billId) {
            window.location.href = 'view_data_super.php?id=' + billId;
        }
        ...
        function rejectBill(billId) {
            ...
            if (comment !== null) {
                ...
                form.method = 'post';
                form.action = 'super_process_bill.php';
