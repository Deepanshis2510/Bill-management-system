...
<body>
    <div class="container">
        ...
        <p><strong>Status:</strong> <?php echo htmlspecialchars($bill['status']); ?> (Review & check by Alok)</p>
        <p><strong>Description:</strong> <?php echo nl2br(htmlspecialchars($bill['description'])); ?></p>
        <p><strong>Data Entry:</strong> <?php echo htmlspecialchars($bill['authorized_person']); ?></p>
...
<?php endif; ?>
        ...
        <!-- Back button -->
        <a href="final_report_super.php" class="back-btn">Back to Bills</a>
    </div>
</body>
</html>
