...
if (isset($_GET['download_csv'])) {
    ...
    header('Content-Disposition: attachment; filename="master_data.csv"');

    // Open a file handle
    $output = fopen('php://output', 'w');

    // Output column headers
    fputcsv($output, array('PARTY NAME', 'PARTY TYPE', 'PARTY Email', 'PARTY Phone', 'GST No', 'PAN NO', 'GST Certificate', 'PAN Certificate', 'Other Certificates 1', 'Other Certificates 2', 'Other Certificates 3', 'Other Certificates 4'));
...
<body>
    <div class="container">
        ...
        <a href="?download_csv=true" class="back-button">Download CSV</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($data['party_email']); ?></td>
                    <td><?php echo htmlspecialchars($data['party_phn']); ?></td>
