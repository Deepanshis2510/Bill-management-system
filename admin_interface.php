...
<div class="container">
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="./api/pending_bill.php">Pending Bills</a></li>
                <li><a href="./api/admin_entry_bill.php">Add Bills</a></li>
                <li><a href="./api/admin_entry_cheque.php">Add Cheque</a></li>
                <li><a href="./api/report_cheque_admin.php">Report Cheque</a></li>
                <li><a href="manage_banks.php">Manage Bank </a></li>
                <li><a href="./api/admin_report.php">Report Bill</a></li>
                <li><a href="./api/rejected_bil.php">Rejected Bill</a></li>
                <li><a href="./api/admin_master_data.php">Master Data</a></li>
                <li><a href="./api/add_user_admin.php">Add User</a></li>
                <li><a href="./api/manage_users.php">Manage User</a></li>
        ...
        <main class="content">
            ...
            <div class="statistics">
                ...
                <div class="stat-box">
                    <h2>Total Forward For Approval Bills</h2>
